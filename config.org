  ...
  :END:" "Template for org-contacts.")
    ...
    (org-capture-templates
     `(("B" "Book" checkitem (file+headline "~/Documents/org/other/books.org" "Books")
       ...
       ("L" "Learning" checkitem (file+headline "~/Documents/org/other/learning.org" "Things")
        "- [ ] %^{Thing}"
        :immediate-finish t)

       ("M" "Movie" checkitem (file+headline "~/Documents/org/other/movies.org" "Movies")
        "- [ ] %^{Movie}"
        :immediate-finish t)

       ("P" "Purchase" checkitem (file+headline "~/Documents/org/other/purchases.org" "Purchases")
        "- [ ] %^{Item}"
        :immediate-finish t)

       ("c" "Contact" entry (file+headline "~/Documents/org/agenda/contacts.org" "Friends"),
        my/org-contacts-template
        :empty-lines 1)

       ("p" "People" entry (file+headline "~/Documents/org/agenda/people.org" "Tasks"),
        my/org-basic-task-template
        :empty-lines 1)

       ("s" "Work" entry (file+headline "~/Documents/org/agenda/work.org" "Tasks"),
        my/org-basic-task-template
        :empty-lines 1)
