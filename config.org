...
** GCC 
:PROPERTIES:
:ID:       2b6daa54-9a91-4fc4-aa45-6574a7a5bd8a
:END:
#+begin_src emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-foreground 'linum-highlight-face "#FBB829")
  (set-face-background 'linum-highlight-face "#1C1B19")
#+END_SRC
* Backups
:PROPERTIES:
...
* Flycheck
:PROPERTIES:
:ID:       91f109fb-cbb0-4fb1-8d5c-4815948f09b3
:END:
#+begin_src emacs-lisp
